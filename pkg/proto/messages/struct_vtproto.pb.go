...
func (m *Value_Float64Value) CloneVT() isValue_Kind {
	if m == nil {
		return (*Value_Float64Value)(nil)
	}
	r := &Value_Float64Value{
		Float64Value: m.Float64Value,
	}
	return r
}

func (m *Value_Float32Value) CloneVT() isValue_Kind {
	if m == nil {
		return (*Value_Float32Value)(nil)
	}
	r := &Value_Float32Value{
		Float32Value: m.Float32Value,
	}
	return r
}

func (m *Value_Int32Value) CloneVT() isValue_Kind {
	if m == nil {
		return (*Value_Int32Value)(nil)
	}
	r := &Value_Int32Value{
...
func (m *Value_Uint32Value) CloneVT() isValue_Kind {
	if m == nil {
		return (*Value_Uint32Value)(nil)
	}
	r := &Value_Uint32Value{
		Uint32Value: m.Uint32Value,
	}
	return r
}
...
func (m *Value_StructValue) CloneVT() isValue_Kind {
	...
	r := &Value_StructValue{
		StructValue: m.StructValue.CloneVT(),
	}
	return r
}
...
func (m *Value_ListValue) CloneVT() isValue_Kind {
	...
	r := &Value_ListValue{
		ListValue: m.ListValue.CloneVT(),
	}
	return r
}

func (m *Value_TimestampValue) CloneVT() isValue_Kind {
	if m == nil {
		return (*Value_TimestampValue)(nil)
	}
	r := &Value_TimestampValue{}
	if rhs := m.TimestampValue; rhs != nil {
		if vtpb, ok := interface{}(rhs).(interface{ CloneVT() *timestamppb.Timestamp }); ok {
			r.TimestampValue = vtpb.CloneVT()
		} else {
			r.TimestampValue = proto.Clone(rhs).(*timestamppb.Timestamp)
		}
	}
	return r
}
...
func (this *Value_Float64Value) EqualVT(thatIface isValue_Kind) bool {
	that, ok := thatIface.(*Value_Float64Value)
	if !ok {
		return false
	}
	if this == that {
	...
	if this.Float64Value != that.Float64Value {
		return false
	}
	return true
}

func (this *Value_Float32Value) EqualVT(thatIface isValue_Kind) bool {
	that, ok := thatIface.(*Value_Float32Value)
	if !ok {
		return false
	}
	if this == that {
	...
	if this.Float32Value != that.Float32Value {
		return false
	}
	return true
}

func (this *Value_Int32Value) EqualVT(thatIface isValue_Kind) bool {
	that, ok := thatIface.(*Value_Int32Value)
	if !ok {
		return false
	}
	if this == that {
...
func (this *Value_Uint32Value) EqualVT(thatIface isValue_Kind) bool {
	that, ok := thatIface.(*Value_Uint32Value)
	if !ok {
		return false
	}
	if this == that {
	...
	if this.Uint32Value != that.Uint32Value {
		return false
	}
	return true
}
...
func (this *Value_TimestampValue) EqualVT(thatIface isValue_Kind) bool {
	that, ok := thatIface.(*Value_TimestampValue)
	if !ok {
		return false
	}
	if this == that {
...
func (m *Value_Float64Value) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Value_Float64Value) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 8
	binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.Float64Value))))
	i--
	dAtA[i] = 0x11
	return len(dAtA) - i, nil
}
func (m *Value_Float32Value) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Value_Float32Value) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 4
	binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.Float32Value))))
	i--
	dAtA[i] = 0x1d
	return len(dAtA) - i, nil
}
func (m *Value_Int32Value) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Value_Int32Value) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.Int32Value))
	i--
	dAtA[i] = 0x20
	return len(dAtA) - i, nil
}
...
func (m *Value_Uint32Value) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *Value_Uint32Value) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.Uint32Value))
	i--
	dAtA[i] = 0x30
	return len(dAtA) - i, nil
}
...
func (m *Value_Uint64Value) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.Uint64Value))
	i--
	dAtA[i] = 0x38
	return len(dAtA) - i, nil
}
...
func (m *Value) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	...
	if msg, ok := m.Kind.(*Value_TimestampValue); ok {
	...
	if msg, ok := m.Kind.(*Value_Uint64Value); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Kind.(*Value_Uint32Value); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Kind.(*Value_Int64Value); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Kind.(*Value_Int32Value); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Kind.(*Value_Float32Value); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
	...
	if msg, ok := m.Kind.(*Value_Float64Value); ok {
		size, err := msg.MarshalToSizedBufferVTStrict(dAtA[:i])
		if err != nil {
			return 0, err
		}
...
func (m *Value_Float64Value) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Value_Float64Value) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 8
	binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.Float64Value))))
	i--
...
func (m *Value_Float32Value) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Value_Float32Value) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i -= 4
	binary.LittleEndian.PutUint32(dAtA[i:], uint32(math.Float32bits(float32(m.Float32Value))))
	i--
...
func (m *Value_Int32Value) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Value_Int32Value) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.Int32Value))
	i--
	dAtA[i] = 0x20
...
func (m *Value_Int64Value) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Value_Int64Value) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.Int64Value))
	i--
	dAtA[i] = 0x28
...
func (m *Value_Uint32Value) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Value_Uint32Value) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.Uint32Value))
	i--
	dAtA[i] = 0x30
...
func (m *Value_Uint64Value) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Value_Uint64Value) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	i = encodeVarint(dAtA, i, uint64(m.Uint64Value))
	i--
	dAtA[i] = 0x38
...
func (m *Value_TimestampValue) MarshalToVTStrict(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVTStrict(dAtA[:size])
}

func (m *Value_TimestampValue) MarshalToSizedBufferVTStrict(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.TimestampValue != nil {
		if vtmsg, ok := interface{}(m.TimestampValue).(interface {
...
func (m *Value_Float64Value) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Value_Float32Value) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Value_Int32Value) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sov(uint64(m.Int32Value))
	return n
}
...
func (m *Value_Uint32Value) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sov(uint64(m.Uint32Value))
	return n
}
...
func (m *Value) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			iNdEx += 8
			m.Kind = &Value_Float64Value{Float64Value: float64(math.Float64frombits(v))}
		case 3:
			if wireType != 5 {
				return fmt.Errorf("proto: wrong wireType = %d for field Float32Value", wireType)
			}
			var v uint32
			if (iNdEx + 4) > l {
				return io.ErrUnexpectedEOF
			...
			iNdEx += 4
			m.Kind = &Value_Float32Value{Float32Value: float32(math.Float32frombits(v))}
		case 4:
			if wireType != 0 {
			...
			m.Kind = &Value_Int32Value{Int32Value: v}
		case 5:
			if wireType != 0 {
		...
		case 6:
			...
			m.Kind = &Value_Uint32Value{Uint32Value: v}
		case 7:
			if wireType != 0 {
